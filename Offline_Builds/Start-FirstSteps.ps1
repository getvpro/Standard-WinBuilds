...
Copy-item -Path "$CDDrive\Scripts\Start-OptimizeBaseImage.ps1" -Destination c:\admin\Scripts
Copy-item -Path "$CDDrive\Scripts\Start-WinUpdates.ps1" -Destination c:\admin\Scripts
Copy-item -Path "$CDDrive\Scripts\Start-WinUpdates.xml" -Destination c:\admin\Scripts

Copy-item -Path "$CDDrive\Scripts\Monitor-WinUpdates.ps1" -Destination c:\admin\Scripts
Copy-item -Path "$CDDrive\Scripts\Monitor-WinUpdates.xml" -Destination c:\admin\Scripts

Copy-item -Path "$CDDrive\Scripts\Import-GPOs.ps1" -Destination c:\admin\Scripts
Copy-item -Path "$CDDrive\Scripts\Start-ClonePrep.ps1" -Destination c:\admin\Scripts
Copy-item -Path "$CDDrive\Scripts\Start-AppInstalls.ps1" -Destination c:\admin\Scripts
Copy-item -Path "$CDDrive\Scripts\" -Destination c:\admin\Scripts

Copy-item -Path "$CDDrive\Scripts\ServiceUI.exe" -Destination "C:\Windows\System32"
